...
export function getAdminMatchResults(params) { return apiClient.get('/matching/admin/results', { params }).then(getResult) }
export function getAdminMatchResult(applicationId) { return apiClient.get(`/matching/admin/results/${applicationId}`).then(getResult) }