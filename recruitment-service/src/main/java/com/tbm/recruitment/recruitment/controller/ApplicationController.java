...
public class ApplicationController {
  ...
  @GetMapping(value = "/job/{jobId}/events", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
  public SseEmitter streamJobApplicationListEvents(
      @PathVariable UUID jobId,
      @RequestHeader(value = "X-Account-Id", required = false) String accountId,
      @RequestHeader(value = "X-Account-Role", required = false) String accountRole) {
    return applicationService.subscribeToOwnedJobEvents(jobId, accountId, accountRole);
  }
